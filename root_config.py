...
class RootConfig:
    ...
    # Native IP,PORT (need to be modified to the same HOST and PORT in easy-flow/src/assets/js/host.js) Try not to modify the port number
    SERVER_HOST = "xxx.xx.xx.xx"
    SERVER_PORT = "8002"
    ...
    # self_rag model
    selfRAG_model_path = root_path + "dir_model/generator/selfrag_llama2_7b"
    ...
    # llama2 model
    llama2_model_path =  root_path + "dir_model/generator/Llama-2-7b-chat-hf"
    ...
    # baichuan2 model
    baichuan2_model_path =  root_path + "dir_model/generator/Baichuan2-13B-Chat"
    ...
    NED_model_path = root_path + "dir_model/generator/NED_model"
    ...
    WikiSP_model_path = root_path + "dir_model/generator/WikiSP_sparql_model"
    ...
    # BGE model
    BGE_model_path = root_path + "dir_model/retriever/BGE/BGE-Reproduce"
    ...
    # contriever model
    contriever_model_path = root_path + "dir_model/retriever/contriever/contriever_msmarco_model"
    ...
    # DPR model
    DPR_model_path = root_path + "dir_model/retriever/DPR/facebook-dpr-question_encoder-multiset-base"
    ...
    # BERT model
    BERT_model_path = root_path + "dir_model/retriever/BERT/Bert-base"
    if not os.path.exists(BERT_model_path):
        print("BERT Does not exist locally, requires online loading...")
        BERT_model_path = "google-bert/bert-base-uncased"

    # E5 model
    E5_model_path = root_path + "dir_model/retriever/E5/e5-mistral-7b-instruct"
    ...
    # verbalizer model
    verbalizer_model_path = root_path + "dir_model/verlizer/t5-large_T-F_ID-T/val_avg_bleu=54.5600-step_count=3.ckpt"
    ...
    T5_model_path = root_path + "dir_model/verlizer/t5-large"
