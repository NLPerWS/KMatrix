...
class AutoModelForPreTraining:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelForPreTraining
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelWithLMHead:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelWithLMHead
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForCausalLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelForCausalLM
            >>> # Download configuration from S3 and cache.
...
class AutoModelForMaskedLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelForMaskedLM
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForSeq2SeqLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelForSeq2SeqLM
            >>> # Download configuration from S3 and cache.
...
class AutoModelForSequenceClassification:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelForSequenceClassification
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForQuestionAnswering:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelForQuestionAnswering
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForTokenClassification:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelForTokenClassification
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForMultipleChoice:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModelForMultipleChoice
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
