...
class TFAutoModel(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModel
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, AutoModel
...
class TFAutoModelForPreTraining(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelForPreTraining
            >>> # Download configuration from S3 and cache.
...
class TFAutoModelWithLMHead(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelWithLMHead
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForCausalLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelForCausalLM
            >>> # Download configuration from S3 and cache.
...
class TFAutoModelForMaskedLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelForMaskedLM
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForSeq2SeqLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelForSeq2SeqLM
            >>> # Download configuration from S3 and cache.
...
class TFAutoModelForSequenceClassification(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelForSequenceClassification
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForQuestionAnswering(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelForQuestionAnswering
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForTokenClassification:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelForTokenClassification
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForMultipleChoice:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import AutoConfig, TFAutoModelForMultipleChoice
            >>> # Download configuration from S3 and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
