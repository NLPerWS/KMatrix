...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import DPRContextEncoder, DPRContextEncoderTokenizer
...
class DPRQuestionEncoder(DPRPretrainedQuestionEncoder):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import DPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class DPRReader(DPRPretrainedReader):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from verbalizer_transformers import DPRReader, DPRReaderTokenizer
