...
from verbalizer_transformers import MarianConfig, MarianMTModel, MarianTokenizer
from verbalizer_transformers.hf_api import HfApi
...
if __name__ == "__main__":
    """
    To bulk convert, run
    >>> from verbalizer_transformers.convert_marian_to_pytorch import make_tatoeba_registry, convert_all_sentencepiece_models
