...
# Copied from from verbalizer_transformers.modeling_tf_bert.TFBertAttention with Bert->Electra
...
# Copied from verbalizer_transformers.modeling_tf_bert.TFBertLayer with Bert->Electra
...
# Copied from verbalizer_transformers.modeling_tf_bert.TFBertEncoder with Bert->Electra
...
class TFElectraEmbeddings(tf.keras.layers.Layer):
    ...
    # Copied from verbalizer_transformers.modeling_tf_bert.TFBertEmbeddings.call
    def call(
        self,
        input_ids=None,
        position_ids=None,
    ...
    # Copied from verbalizer_transformers.modeling_tf_bert.TFBertEmbeddings._embedding
...
class TFElectraForPreTraining(TFElectraPreTrainedModel):
    ...
    def call(
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from verbalizer_transformers import ElectraTokenizer, TFElectraForPreTraining
