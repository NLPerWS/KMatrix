...
# Copied from verbalizer_transformers.modeling_tf_xlm.TFXLMMultiHeadAttention with XLM->Flaubert
...
# Copied from verbalizer_transformers.modeling_tf_xlm.TFXLMTransformerFFN
...
# Copied from verbalizer_transformers.modeling_tf_xlm.TFXLMPredLayer
