...
def post_processor(verbalizer_inputs,verbalizer_outputs):
    
    # verbalizer_inputs="./data/test_table_name.source"
    # verbalizer_outputs="./table_name_test_verbalizer_predict/val_outputs/test_table_name_predictions_rank0.txt"
    ...
    args.verbalizer_inputs=verbalizer_inputs
    args.verbalizer_outputs=verbalizer_outputs
