...
from kninjllm.llm_common.errors import PipelineDrawingError
from kninjllm.llm_pipeline.descriptions import find_pipeline_inputs, find_pipeline_outputs
from kninjllm.llm_utils.type_utils import _type_name
...
def _to_mermaid_image(graph: networkx.MultiDiGraph):
    ...
    try:
        ...
        raise PipelineDrawingError(
            "There was an issue with https://mermaid.ink/, see the kninjllm_trace for details."
        ) from exc
