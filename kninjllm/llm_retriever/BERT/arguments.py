...
class DataArguments:
    ...
    train_data: str = field(
        default="", metadata={"help": "One or more paths to training data", "nargs": "+"}
    )
    ...
    max_example_num_per_dataset: int = field(
        default=1000000, metadata={"help": "the max number of examples for each dataset"}
    )
    ...
    fewshot_training: bool = field(
            default=False, metadata={"help": "If add few-shot examples during training."}
    )
    model_type: Optional[str] = field(
        default="BERT", metadata={"help": "Which type of model, BERT or T5 or LLM"}
    )
    use_instruction: bool = field(
            default=False, metadata={"help": "whether to use instruction"}
    )    
...
class RetrieverTrainingArguments(TrainingArguments):
    ...
    lora_tune: bool = field(default=False, metadata={"help": "Train using LoRA"})
    use_flash_attn: bool = field(default=False, metadata={"help": "Train using Flash attention"})
    resume_from_ckpt: str = field(default=None, metadata={"help": "Resume from ckpt"})